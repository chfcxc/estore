...
public class EstoreCardType implements Serializable {
	...
	public EstoreCardType() {
		
	}

	public EstoreCardType(Integer level, Long storeId, String name, String cardDescribe, Date createTime) {
		super();
		this.level = level;
